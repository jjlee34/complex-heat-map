...
#Heatmap(matrix, name = "mat", column_title = "Samples", column_names_gp = gpar(fontsize = 10), row_title = "Genes", row_names_gp = gpar(fontsize = 5.5), row_order = order(as.numeric(gsub("row", "", rownames(mat)))), column_order = order(as.numeric(gsub("column", "", colnames(mat))))) #Heatmap function for alphabetically sorted gene names
Heatmap(matrix, name = "mat", column_title = "Samples", column_names_gp = gpar(fontsize = 10), row_title = "Genes", row_names_gp = gpar(fontsize = 4)) #Heatmap function for clustered samples
